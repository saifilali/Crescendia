'''
Currently just copies S0, "chop suey"
'''
import argparse
import pymysql
import configparser
...
with connection.cursor() as cursor:
    ...
    if(unit_stats["health_current"] < 1):
        ...
        summary_code = "t{}u{} p +{}".format(target_team, action_target_unit, power_boost)
        summary_text = "{} has power_boosted {} for {} points with Chop Suey!".format(
