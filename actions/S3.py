...
with connection.cursor() as cursor:
    ...
    if(unit_stats["health_current"] < 1):
        ...
        summary_code = "t{} p +{}".format(target_team, action_target_unit, power_boost)
        summary_text = "{} increased the effects of harmony or dissonance bonuses with Unchained Melody for her team by {}!".format(
            unit_stats["title"], power_boost_string) + effective_text
