...
balance = action_helper.get_balance("H1")
cost = balance["cost"]
scale = balance["scale"]
...
with connection.cursor() as cursor:
    ...
    if(unit_stats["health_current"] < 1):
        ...
        heal = (40 + unit_stats["power_current"] * scale) * 0.01 * target_stats["health_default"] * action_helper.key_bonus_ally(
        ...
        summary_text = "{} has healed {} for {} points with Redemption Song!".format(
