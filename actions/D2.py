'''
For now, a copy of D1 (Somewhere over the rainbow)
'''
import argparse
import pymysql
import configparser
...
balance = action_helper.get_balance("D2")
cost = balance["cost"]
scale = balance["scale"]
...
with connection.cursor() as cursor:
    ...
    if(unit_stats["health_current"] < 1):
        ...
        summary_text = "{} has protected {} from the next debuff with Clarity!".format(
