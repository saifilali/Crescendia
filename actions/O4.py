...
balance = action_helper.get_balance("O4")
cost = balance["cost"]
scale = balance["scale"]
...
with connection.cursor() as cursor:
    ...
    if(unit_stats["health_current"] < 1):
        ...
        background_animation = "offensive_action_animation"
        target_animation = "offensive_action_effect"
        
        summary_code = "t{}u{} -{}".format(target_team, action_target_unit, damage)
        summary_text = "{} has hit {} for {} damage with Ice Ice Baby! It has also been stunned".format(
