'''
This one was also pretty easy. Just needs to be tested
'''
import argparse
import pymysql
import configparser
...
balance = action_helper.get_balance("H8")
cost = balance["cost"]
scale = balance["scale"]
...
with connection.cursor() as cursor:
    ...
    if(unit_stats["health_current"] < 1):
        ...
        heal = (10 + (unit_stats["health_default"] - unit_stats["health_current"])) * action_helper.key_bonus_ally(
        ...
        summary_text = "{} has healed {} for {} points with Stairway to Heaven!".format(
